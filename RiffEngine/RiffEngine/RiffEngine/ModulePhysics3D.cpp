...
{
	App->editor->LogConsole("Creating 3D Physics simulation\n");
	bool ret = true;
...
{
	App->editor->LogConsole("Creating Physics environment\n");
...
{
	App->editor->LogConsole("Destroying 3D Physics simulation\n");
...
// ---------------------------------------------------------
PhysBody3D* ModulePhysics3D::AddBody(const rSphere& sphere, float mass, bool isSensor)
{
...
// ---------------------------------------------------------
PhysBody3D* ModulePhysics3D::AddBody(const rCube& cube, float mass, bool isSensor)
{
...
// ---------------------------------------------------------
PhysBody3D* ModulePhysics3D::AddBody(const rCylinder& cylinder, float mass, bool isSensor)
{
